...
public class Config {
	...
	static final double MIN_SCORE = -1000.0;				//-1000.0;					// Minimum possible score
	...
	static final double STABILIZE_TIME = 1.0;				// Time (in sec) for the A/D convert to stabilize (reduce this value to 1 for debugging)
	...
	static final String maleDecTh[] = new String[]{"-3.5", "-2.8", "-2.3"};
//	static final String maleDecTh[] = new String[]{"-0.01","-0.02","-0.03"};
}
