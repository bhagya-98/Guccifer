...
//	public static DatabaseReference rootRef,demoRef, locationRef, scoreRef, soundData;
...
//		demoRef = rootRef.child("user1"); //this will change for 2 more apps
//		locationRef = demoRef.child("location");
//		scoreRef = demoRef.child("score");
//		soundData = demoRef.child("sdata");
		...
		// Initialize objects in SoundProcessing objects. Only need to do once.
	}
		...
		if (position == 0) {		
            ...
            sensitivitySelector.setAdapter(arrayAdapter, new DialogInterface.OnClickListener() {
		        ...
		        public void onClick(DialogInterface dialog, int which) {
		        		prefs.edit().putString("sensitivity", thresholds[which]).apply();
